...
public class RelativeMoney2 : MonoBehaviour
{
    ...
    */
    ...
    void Start()
    {
        ...
        _PlayerMoney = Player.GetComponent<PlayerMoney2>();
    }
    ...
    */
    public bool GetSetTakeInfo
    {
        ...
        set { _HaveInfoRelative.GetComponent<RelativeMoney2>().GetSetTakeInfo = value; }
    }
}